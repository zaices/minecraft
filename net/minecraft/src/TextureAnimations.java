...
public class TextureAnimations
{
    ...
    public static void update()
    {
        ...
        textureAnimations = getTextureAnimations(rp);
        updateAnimations();
    }
    ...
    public static TextureAnimation[] getTextureAnimations(ResourcePack rp)
    {
                ...
                else
                {
                    ...
                    for (int anims = 0; anims < animPropNames.length; ++anims)
                    {
                        ...
                        try
                        {
                            ...
                            InputStream in = rp.func_110590_a(e);
                    ...
                    TextureAnimation[] var13 = (TextureAnimation[])((TextureAnimation[])list.toArray(new TextureAnimation[list.size()]));
                    return var13;
                }
            }
        }
        ...
        if (texFrom != null && texTo != null)
        {
            if (x >= 0 && y >= 0 && width >= 0 && height >= 0)
            {
                ...
                else
                {
                    ...
                    if (!Config.hasResource(locTexTo, true))
                    {
                    ...
                    {
                        TextureObject destTex = TextureUtils.getTexture(locTexTo);
                        ...
                        {
                            int destTexId = destTex.func_110552_b();
