...
public class PlayerControllerMP
{
    ...
    public MEntityClientPlayerMP func_78754_a(World par1World)
    {
        return new MEntityClientPlayerMP(this.mc, par1World, this.mc.func_110432_I(), this.netClientHandler);
    }
