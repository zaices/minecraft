    ...
    private static void readCustomPalettes(Properties props, String fileName)
    {
        ...
        for (int var20 = 0; var20 < var19.length; ++var20)
        {
            ...
            for (int ix = 0; ix < indexStrs.length; ++ix)
            {
                ...
                {
                    if (var21 != Block.grass.blockID && var21 != Block.tallGrass.blockID && var21 != Block.leaves.blockID && var21 != Block.vine.blockID)
                    {
                        if (metadata == -1)
                        {
                ...
                if (b == null)
                {
                    switch (type)
                    {
                        ...
                        case 2:
                            ...
                            {
                                var17 = blockAccess.getBiomeGenForCoords(r, g).getBiomeFoliageColor();
                            }
