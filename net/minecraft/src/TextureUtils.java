...
public class TextureUtils
{
    ...
    {
        TextureObject tex = Config.getTextureManager().func_110581_b(loc);
        ...
        else
        {
            ...
            Config.getTextureManager().func_110579_a(loc, tex1);
            return tex1;
        }
    }
